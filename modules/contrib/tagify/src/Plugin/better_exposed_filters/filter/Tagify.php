...
#[FiltersWidget(
  id: 'bef_tagify',
  title: new TranslatableMarkup('Tagify'),
)]
class Tagify extends FilterWidgetBase {
  ...
  public function defaultConfiguration(): array {
    ...
    $config['advanced']['match_operator'] = MatchOperator::Contains->value;
  ...
  public static function elementValidate(array $element, FormStateInterface $form_state): void {
    ...
    if ($value && ($items = json_decode($value, associative: TRUE, flags: JSON_THROW_ON_ERROR))) {
