...
class DxprBuilderProfileForm extends EntityForm {
  ...
  public function form(array $form, FormStateInterface $form_state): array {
    ...
    $addCheckUncheckAll = function (string $wrapper, string $field) use (&$form) {
      ...
      $form[$wrapper]['check_uncheck_all_wrapper']['check_uncheck_all'] = [
        '#type' => 'checkbox',
    ...
    $addCheckUncheckAll('inline_buttons', 'inline_buttons');
    $addCheckUncheckAll('modal_buttons', 'modal_buttons');
