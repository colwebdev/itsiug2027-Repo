...
/* __string_template__f0954ffbfff75945e4a59985a578af82 */
class __TwigTemplate_96e51180f6f9ba8108743009badef710 extends Template
{
    ...
    protected function doDisplay(array $context, array $blocks = []): iterable
    {
        $macros = $this->macros;
        // line 2
        yield from $this->load("__string_template__f0954ffbfff75945e4a59985a578af82", 2, 1)->unwrap()->yield($context);
        yield from [];
    }
    ...
    {
        return "__string_template__f0954ffbfff75945e4a59985a578af82";
    }
    ...
    {
        return new Source("", "__string_template__f0954ffbfff75945e4a59985a578af82", "");
    }
...
/* __string_template__f0954ffbfff75945e4a59985a578af82 */
class __TwigTemplate_96e51180f6f9ba8108743009badef710___1 extends Template
{
    private Source $source;
    /**
     * @var array<string, Template>
    ...
    public function __construct(Environment $env)
    {
        ...
        $this->blocks = [
            'background_media' => [$this, 'block_background_media'],
    ...
    {
        $macros = $this->macros;
        $this->parent = $this->load("convene_theme:hero", 2);
        yield from $this->parent->unwrap()->yield($context, array_merge($this->blocks, $blocks));
        $this->env->getExtension('\Drupal\Core\Template\TwigExtension')
            ->checkDeprecations($context, ["background_media", "heading", "subheading", "actions"]);    }

    // line 3
    /**
     * @return iterable<null|scalar|\Stringable>
     */
    public function block_background_media(array $context, array $blocks = []): iterable
    {
        $macros = $this->macros;
        // line 4
        yield "    ";
