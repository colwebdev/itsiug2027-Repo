...
class __TwigTemplate_540d3d9c9ee9d83e8c2676eb5c96328e extends Template
{
    ...
    protected function doDisplay(array $context, array $blocks = []): iterable
    {
        ...
        if ((($tmp = ($context["links"] ?? null)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            ...
            // line 42
            yield "<ul";
            yield (string) $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, CoreExtension::getAttribute($this->env, $this->source, ($context["attributes"] ?? null), "addClass", ["dropbutton--gin"], "method", false, false, true, 42), "html", null, true);
            yield ">";
            // line 43
      ...
      ";
                ...
                // line 48
                yield "      <li";
                yield (string) $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, $context["item"], "attributes", [], "any", false, false, true, 48), "addClass", ["dropbutton__item"], "method", false, false, true, 48), "html", null, true);
                yield ">";
                // line 49
                if ((($tmp = CoreExtension::getAttribute($this->env, $this->source, $context["item"], "link", [], "any", false, false, true, 49)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
                    // line 50
                    yield (string) $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, CoreExtension::getAttribute($this->env, $this->source, $context["item"], "link", [], "any", false, false, true, 50), "html", null, true);
...
$context["item"], "text_attributes", [], "any", false, false, true, 51)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
                    // line 52
                    yield "<span";
                    yield (string) $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, CoreExtension::getAttribute($this->env, $this->source, $context["item"], "text_attributes", [], "any", false, false, true, 52), "html", null, true);
                    yield ">";
                    ...
                    // line 54
                    yield (string) $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, CoreExtension::getAttribute($this->env, $this->source, $context["item"], "text", [], "any", false, false, true, 54), "html", null, true);
                }
                // line 56
                yield "</li>
      ";
                // line 57
                if (((CoreExtension::getAttribute($this->env, $this->source, $context["loop"], "length", [], "any", false, false, true, 57) > 1) && (($tmp = CoreExtension::getAttribute($this->env, $this->source, $context["loop"], "last", [], "any", false, false, true, 57)) && $tmp instanceof Markup ? (string) $tmp : $tmp))) {
                    // line 58
                    yield "        </ul>
      </li>
      ";
    ...
    {
        return array (  139 => 62,  121 => 58,  119 => 57,  116 => 56,  113 => 54,  106 => 52,  104 => 51,  102 => 50,  100 => 49,  96 => 48,  91 => 45,  89 => 44,  72 => 43,  68 => 42,  60 => 39,  50 => 37,  48 => 36,  46 => 35,  44 => 34,);
    }

    public function getSourceContext(): Source
    {
        return new Source("", "themes/contrib/gin/templates/form/links--dropbutton.html.twig", "/home/itsiugor/public_html/themes/contrib/gin/templates/form/links--dropbutton.html.twig");
    }
