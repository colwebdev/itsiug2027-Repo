...
class __TwigTemplate_15257bcd8842d29fb4ebd53662d8bef5 extends Template
{
...
<html";
  ...
  <body";
        // line 43
        yield (string) $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, CoreExtension::getAttribute($this->env, $this->source, ($context["attributes"] ?? null), "addClass", [($context["body_classes"] ?? null)], "method", false, false, true, 43), "html", null, true);
        yield ">
    ";
        // line 48
    ...
    ";
        // line 51
        yield (string) $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->extensions['Drupal\Core\Template\TwigExtension']->withoutFilter(($context["page_top"] ?? null), "gin_secondary_toolbar"), "html", null, true);
        yield "
    ";
        // line 52
...
";
    ...
    {
        return new Source("", "themes/contrib/gin/templates/html.html.twig", "/home/itsiugor/public_html/themes/contrib/gin/templates/html.html.twig");
    }
    ...
    public function checkSecurity()
    {
        ...
        try {
            $this->sandbox->checkSecurity(
                [0 => "set"],
                [0 => "clean_class", 1 => "escape", 2 => "safe_join", 3 => "t", 4 => "without"],
                [],
                [],
                $this->source
            );
