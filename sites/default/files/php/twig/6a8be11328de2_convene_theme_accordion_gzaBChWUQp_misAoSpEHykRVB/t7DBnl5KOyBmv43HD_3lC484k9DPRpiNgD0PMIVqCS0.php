...
/* convene_theme:accordion */
class __TwigTemplate_1afdfd5b8b05f468d6265f26c79f1107 extends Template
{
    ...
    protected function doDisplay(array $context, array $blocks = []): iterable
    {
        $macros = $this->macros;
        // line 1
        yield (string) $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar($this->extensions['Drupal\Core\Template\TwigExtension']->attachLibrary("core/components.convene_theme--accordion"));
        yield (string) $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar($this->extensions['Drupal\Core\Template\ComponentsTwigExtension']->addAdditionalContext($context, "convene_theme:accordion"));
        yield (string) $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar($this->extensions['Drupal\Core\Template\ComponentsTwigExtension']->validateProps($context, "convene_theme:accordion"));
        $context["classes"] = ["accordion-item", (((($tmp =         // line 3
($context["admin_theme"] ?? null)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? ("accordion-item--admin-theme") : ("accordion-item--themed"))];
        // line 5
        yield "
<div";
        // line 6
        ...
        yield ">
  <div role=\"button\" tabindex=\"0\" class=\"accordion-item__trigger\" aria-expanded=\"false\">
...
";
        $this->env->getExtension('\Drupal\Core\Template\TwigExtension')
            ->checkDeprecations($context, ["admin_theme", "attributes", "title", "content"]);        yield from [];
    }
    ...
    {
        return "convene_theme:accordion";
    }
    ...
    {
        return array (  81 => 14,  59 => 9,  53 => 6,  50 => 5,  48 => 3,  44 => 1,);
    }

    public function getSourceContext(): Source
    {
        return new Source("", "convene_theme:accordion", "themes/contrib/convene_theme/components/accordion/accordion.twig");
    }
