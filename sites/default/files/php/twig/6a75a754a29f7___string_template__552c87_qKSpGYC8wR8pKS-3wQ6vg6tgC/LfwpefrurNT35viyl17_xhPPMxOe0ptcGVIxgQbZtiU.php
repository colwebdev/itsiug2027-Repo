...
/* __string_template__552c87565b6f77f75fcc80520b8f6389 */
class __TwigTemplate_1e08ae00d6efffe9e8a346f8936eea5d extends Template
{
    ...
    protected function doDisplay(array $context, array $blocks = []): iterable
    {
        $macros = $this->macros;
        // line 2
        yield from $this->load("__string_template__552c87565b6f77f75fcc80520b8f6389", 2, 1)->unwrap()->yield($context);
        yield from [];
    }
    ...
    {
        return "__string_template__552c87565b6f77f75fcc80520b8f6389";
    }
    ...
    {
        return new Source("", "__string_template__552c87565b6f77f75fcc80520b8f6389", "");
    }
...
/* __string_template__552c87565b6f77f75fcc80520b8f6389 */
class __TwigTemplate_1e08ae00d6efffe9e8a346f8936eea5d___1 extends Template
{
    private Source $source;
    /**
     * @var array<string, Template>
    ...
    public function __construct(Environment $env)
    {
        ...
        $this->blocks = [
            'timeline_items' => [$this, 'block_timeline_items'],
    ...
    {
        $macros = $this->macros;
        $this->parent = $this->load("convene_theme:timeline_module", 2);
        yield from $this->parent->unwrap()->yield($context, array_merge($this->blocks, $blocks));
        $this->env->getExtension('\Drupal\Core\Template\TwigExtension')
            ->checkDeprecations($context, ["timeline_items", "actions"]);    }

    // line 3
    /**
     * @return iterable<null|scalar|\Stringable>
     */
    public function block_timeline_items(array $context, array $blocks = []): iterable
    {
        $macros = $this->macros;
        // line 4
        yield "    ";
