...
/* __string_template__9b070c391244b4197d6e3006c18290a2 */
class __TwigTemplate_2394753676c0bfdd8627c7eaf3358da9 extends Template
{
    ...
    protected function doDisplay(array $context, array $blocks = []): iterable
    {
        $macros = $this->macros;
        // line 2
        yield from $this->load("__string_template__9b070c391244b4197d6e3006c18290a2", 2, 1)->unwrap()->yield($context);
        yield from [];
    }
    ...
    {
        return "__string_template__9b070c391244b4197d6e3006c18290a2";
    }
    ...
    {
        return new Source("", "__string_template__9b070c391244b4197d6e3006c18290a2", "");
    }
...
/* __string_template__9b070c391244b4197d6e3006c18290a2 */
class __TwigTemplate_2394753676c0bfdd8627c7eaf3358da9___1 extends Template
{
    private Source $source;
    /**
     * @var array<string, Template>
    ...
    {
        $macros = $this->macros;
        $this->parent = $this->load("convene_theme:agenda_item_molecule", 2);
        yield from $this->parent->unwrap()->yield($context, array_merge($this->blocks, $blocks));
        $this->env->getExtension('\Drupal\Core\Template\TwigExtension')
            ->checkDeprecations($context, ["actions"]);    }
