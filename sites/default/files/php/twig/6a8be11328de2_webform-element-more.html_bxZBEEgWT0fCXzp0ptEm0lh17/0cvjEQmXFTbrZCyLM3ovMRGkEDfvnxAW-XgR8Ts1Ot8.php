...
class __TwigTemplate_b6ae09601e1251b0eb73f7d915afde35 extends Template
{
...
";
  ...
  <div class=\"webform-element-more--link\"><a role=\"button\" href=\"#";
        ...
        if ((isset($context["canvas_is_preview"]) && $context["canvas_is_preview"]) && \array_key_exists("canvas_uuid", $context)) {
            if (\array_key_exists("canvas_slot_ids", $context) && \in_array("more_title", $context["canvas_slot_ids"], TRUE)) {
                yield \sprintf('<!-- canvas-slot-%s-%s/%s -->', "start", $context["canvas_uuid"], "more_title");
            } else {
                yield \sprintf('<!-- canvas-prop-%s-%s/%s -->', "start", $context["canvas_uuid"], "more_title");
            }
        }
        ...
        if ((isset($context["canvas_is_preview"]) && $context["canvas_is_preview"]) && \array_key_exists("canvas_uuid", $context)) {
            if (\array_key_exists("canvas_slot_ids", $context) && \in_array("more_title", $context["canvas_slot_ids"], TRUE)) {
                yield \sprintf('<!-- canvas-slot-%s-%s/%s -->', "end", $context["canvas_uuid"], "more_title");
            } else {
                yield \sprintf('<!-- canvas-prop-%s-%s/%s -->', "end", $context["canvas_uuid"], "more_title");
            }
        }
        yield "</a></div>
  <div id=\"";
...
";
    ...
    {
        return array (  75 => 28,  55 => 27,  50 => 26,  48 => 21,  44 => 19,);
    }

    public function getSourceContext(): Source
    {
        return new Source("", "modules/contrib/webform/templates/webform-element-more.html.twig", "/home/itsiugor/public_html/modules/contrib/webform/templates/webform-element-more.html.twig");
    }
